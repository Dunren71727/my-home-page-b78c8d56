...
export function CategoryTabContent({ 
  ...
  return (
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6" style={{ gridTemplateColumns: categorySubcategories.length <= 4 ? `repeat(${Math.min(categorySubcategories.length, 4)}, 1fr)` : undefined }}>
